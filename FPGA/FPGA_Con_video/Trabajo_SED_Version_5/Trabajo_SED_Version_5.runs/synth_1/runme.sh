...
HD_PWD='C:/Users/Leonard Matulescu/Desktop/Universidad/Proyectos Vivado/Trabajo_SED_Version_5/Trabajo_SED_Version_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TransmisorFM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TransmisorFM.tcl
